<template>
  <div class="insights-performance">
    <div class="insight-section">
      ...
      <p class="section-description">Overall system performance indicators</p>
    ...
    <div class="insight-section">
      ...
      <p class="section-description">Compare key metrics across different agents</p>
    ...
    <div class="insight-section">
      ...
      <p class="section-description">How key metrics have evolved over time</p>
