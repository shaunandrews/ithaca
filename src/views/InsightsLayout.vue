  ...
  <div class="insights-container">
    <header ref="headerRef">
      <div class="insights-header-start">
        ...
        <p class="insights-subtitle">Analytics and performance data across your agents, experts, and tools</p>
        <nav>
          <ul>
            <li :class="{ active: isActiveTab('topics') }">
              <router-link to="/insights/topics">Topics</router-link>
            </li>
            <li :class="{ active: isActiveTab('sentiment') }">
              <router-link to="/insights/sentiment">Sentiment</router-link>
            </li>
            <li :class="{ active: isActiveTab('performance') }">
              <router-link to="/insights/performance">Performance</router-link>
            </li>
            <li :class="{ active: isActiveTab('activity') }">
              <router-link to="/insights/activity">Activity</router-link>
            </li>
          </ul>
        </nav>
      </div>
