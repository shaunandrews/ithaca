<template>
  <div class="insights-sentiment">
    <div class="insight-section">
      ...
      <p class="section-description">Emotional tone analysis across all conversations</p>
    ...
    <div class="insight-section">
      ...
      <p class="section-description">How customer sentiment has changed over time</p>
    ...
    <div class="insight-section">
      ...
      <p class="section-description">Compare sentiment scores across different agents</p>
      
      <div class="agent-sentiment-list">
        <div class="agent-sentiment-item">
          <div class="agent-info">
            <span class="agent-name">Support Bot Alpha</span>
            <span class="agent-conversations">124 conversations</span>
          </div>
        ...
        <div class="agent-sentiment-item">
          <div class="agent-info">
            ...
            <span class="agent-conversations">89 conversations</span>
          </div>
          <div class="sentiment-score positive">
        ...
        <div class="agent-sentiment-item">
          <div class="agent-info">
            ...
            <span class="agent-conversations">156 conversations</span>
          </div>
