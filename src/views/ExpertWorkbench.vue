<template>
    <div class="expert-workbench">
            ...
            <div class="expert-config-content">
                <div class="instructions">
                    <div class="section-header">
                        ...
                        <p class="section-description">
                            Tell your expert what to do. Add tools by typing
                            @tool.
                        </p>
                    </div>
                    <InstructionsField
                ...
                <div class="tools">
                    <div class="section-header">
                        ...
                        <p class="section-description">
                            Configure the tools available to your expert.
                        </p>
                    </div>
        ...
        <div class="expert-preview-panel">
            <AgentPreview :agent="expert" />
        </div>
    </div>
...
<script setup>
    ...
    const parsedInstructions = computed(() =>
        expert.value ? parseInstructions(expert.value.instructions || expert.value.description) : []
    );
        ...
        if (autocomplete.value.show) {
            if (e.key === 'ArrowDown' || e.key === 'Tab') {
                ...
                autocomplete.value.selected =
                    autocomplete.value.filtered[nextIdx].title;
                ...
                const prevIdx =
                    (idx - 1 + autocomplete.value.filtered.length) %
                    autocomplete.value.filtered.length;
                autocomplete.value.selected =
                    autocomplete.value.filtered[prevIdx].title;
            } else if (e.key === 'Enter') {
                e.preventDefault();
                const tool =
                    autocomplete.value.filtered.find(
                        (t) => t.title === autocomplete.value.selected
