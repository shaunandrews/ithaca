<template>
    <div class="insights-activity">
            ...
            <div class="activity-metrics">
                ...
                <div class="metric-card">
                    ...
                    <div class="metric-content">
                        ...
                        <div class="metric-label">Peak Hour Activity</div>
        ...
        <div class="insight-section">
            ...
            <p class="section-description">
                Agents with the highest conversation volume
            </p>
            ...
            <div class="active-agents-list">
                <div class="agent-activity-item">
                    ...
                    <div class="agent-details">
                        ...
                        <span class="agent-stats"
                            >1,247 conversations • 87% satisfaction</span
                        >
                    </div>
                ...
                <div class="agent-activity-item">
                    ...
                    <div class="agent-details">
                        ...
                        <span class="agent-stats"
                            >892 conversations • 82% satisfaction</span
                        >
                    </div>
                    <div class="activity-bar">
                        <div class="activity-fill" style="width: 72%"></div>
                    </div>
                </div>
                <div class="agent-activity-item">
                    ...
                    <div class="agent-details">
                        ...
                        <span class="agent-stats"
                            >708 conversations • 91% satisfaction</span
                        >
                    </div>
                    <div class="activity-bar">
                        <div class="activity-fill" style="width: 57%"></div>
                    </div>
                </div>
            </div>
        </div>
