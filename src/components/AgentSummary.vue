<template>
    <div class="agent-summary vstack">
        ...
        <div class="feedback-themes vstack">
            ...
            <p>
                The most common things said while reviewing agent conversations.
            </p>
            <div class="themes-list">
                <div
                    v-for="theme in commonFeedbackThemes"
                    :key="theme"
                    class="theme-item"
                >
                    {{ theme }}
...
<script setup>
    ...
    const recentHighlights = computed(() => {
        return props.agent.activity.slice(0, 3).map((item) => ({
            ...item,
