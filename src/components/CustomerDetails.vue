<template>
  <div class="customer-details">
    <div class="customer-header">
      <img :src="gravatarUrl('sarah.jones@example.com')" alt="Customer avatar" height="40" width="40" class="customer-avatar" />
      ...
      <div class="support-list">
        <div class="support-item">
          <div class="support-header">
            <span class="support-subject">Custom CSS not applying to mobile</span>
            <span class="support-date">2 days ago</span>
          </div>
          <div class="support-summary">
            Helped troubleshoot custom CSS issues on mobile devices. Resolved by updating CSS media queries and clearing site cache.
          </div>
        ...
        <div class="support-item">
          <div class="support-header">
            <span class="support-subject">How to set up email forwarding</span>
            <span class="support-date">1 week ago</span>
          </div>
          <div class="support-summary">
            Provided step-by-step instructions for setting up email forwarding from custom domain to Gmail account.
          </div>
          <div class="support-meta">
            <span class="support-status resolved">Resolved</span>
        ...
        <div class="support-item">
          ...
          <div class="support-summary">
            Identified large image files causing slow load times. Recommended image optimization and caching plugins.
          </div>
          <div class="support-meta">
            <span class="support-status resolved">Resolved</span>
        ...
        <div class="support-item">
          <div class="support-header">
            <span class="support-subject">Upgrade to Business Plan</span>
            <span class="support-date">2 months ago</span>
          </div>
          <div class="support-summary">
            Assisted with plan upgrade and migration. Explained new features and helped configure business tools.
          </div>
          <div class="support-meta">
            <span class="support-status resolved">Resolved</span>
